 ...
 */
 ...
 int main()
 {
	 ...
	 test_func.push_back("D");test_func.push_back("-");test_func.push_back("+");test_func.push_back("X");test_func.push_back("!");
	 ...
	 test_func.push_back("*");test_func.push_back("K");test_func.push_back("!");test_func.push_back("*");test_func.push_back("N");
