...
// * HINT *: First, Implementing AND Gates (and NOT Gates), then Implementing OR Gates (without any NOT Gate at the end of them).

/* In some components, the following lines have been used for making the number of each Cluster "EVEN":
 *
 * TEMP_YEK.w_func.clear();
 * TEMP_YEK.w_func.push_back("YEK");
 * TEMP_YEK.w_func.push_back("-");
 * TEMP_YEK.w_func.push_back("*");
 * TEMP_YEK.w_func.push_back("YEK");
 * TEMP_YEK.w_func.push_back("-");
 * TEMP_YEK.w_func.push_back("#");
...
void comp_gates::NAND2(wire& IN1, wire& IN2, wire& OUT) {
    wire w_ini;
    w_ini.value = 0;
    wire IN1_not = w_ini, IN2_not = w_ini;
    NOT_Base (IN1, IN1_not);
    NOT_Base (IN2, IN2_not);
    OR_Base (IN1_not, IN2_not, OUT);
...
void comp_gates::NAND3 (wire& IN1, wire& IN2, wire& IN3, wire& OUT) {
    wire w_ini;
    w_ini.value = 0;
    wire IN1_not = w_ini, IN2_not = w_ini, IN3_not = w_ini, o1 = w_ini;
    NOT_Base (IN1, IN1_not);
    NOT_Base (IN2, IN2_not);
    NOT_Base (IN3, IN3_not);
    OR_Base (IN1_not, IN2_not, o1);
    OR_Base (o1, IN3_not, OUT);
...
void comp_gates::NAND4 (wire& IN1, wire& IN2, wire& IN3, wire& IN4, wire& OUT) {
	wire w_ini;
	w_ini.value = 0;
	wire IN1_not = w_ini, IN2_not = w_ini, IN3_not = w_ini, IN4_not = w_ini, o1 = w_ini, o2 = w_ini;
	NOT_Base (IN1, IN1_not);
	NOT_Base (IN2, IN2_not);
	NOT_Base (IN3, IN3_not);
	NOT_Base (IN4, IN4_not);
	OR_Base (IN1_not, IN2_not, o1);
	OR_Base (IN3_not, IN4_not, o2);
	OR_Base (o1, o2, OUT);
...
void comp_gates::NOR3 (wire& IN1, wire& IN2, wire& IN3, wire& OUT) {
	...
	NOT_Base (IN2, IN2_not);
	NOT_Base (IN3, IN3_not);
	AND_Base (IN1_not, IN2_not, o1);
	AND_Base (o1, IN3_not, OUT);
...
void comp_gates::XNOR3 (wire& IN1, wire& IN2, wire& IN3, wire& OUT) {
	...
	wire o1 = w_ini, o2 = w_ini, o3 = w_ini, o4 = w_ini, o5 = w_ini, o6 = w_ini;
	wire o7 = w_ini, o8 = w_ini, o9 = w_ini, o10 = w_ini;
	AND_Base (temp_IN1, temp_IN2, o1);
	AND_Base (o1, temp_IN3, o2);
	AND_Base (IN1, IN2, o3);
	AND_Base (o3, temp_IN3, o4);
	AND_Base (temp_IN1, IN2, o5);
	AND_Base (o5, IN3, o6);
	AND_Base (IN1, temp_IN2, o7);
	AND_Base (o7, IN3, o8);
	OR_Base (o2, o4, o9);
	OR_Base (o6, o8, o10);
	OR_Base (o9, o10, OUT);
...
void comp_gates::AO21 (wire& X1, wire& X2, wire& Y, wire& OUT) {
    wire w_ini;
    w_ini.value = 0;
    wire o1 = w_ini, o2 = w_ini, TEMP_YEK = w_ini;
    TEMP_YEK.w_func.clear();
    TEMP_YEK.w_func.push_back("YEK");
    TEMP_YEK.w_func.push_back("-");
    TEMP_YEK.w_func.push_back("*");
...
void comp_gates::AO221 (wire& X1, wire& X2, wire& Y1, wire& Y2, wire& K, wire& OUT) {
    wire w_ini;
    w_ini.value = 0;
    wire o1 = w_ini, o2 = w_ini, o3 = w_ini, o4 = w_ini, TEMP_YEK = w_ini;
    TEMP_YEK.w_func.clear();
    TEMP_YEK.w_func.push_back("YEK");
    TEMP_YEK.w_func.push_back("-");
    TEMP_YEK.w_func.push_back("*");
...
void comp_gates::AOI21 (wire& X1, wire& X2, wire& Y, wire& OUT) {
    wire w_ini;
    w_ini.value = 0;
    wire X1_not = w_ini, X2_not = w_ini, Y_not = w_ini, o1 = w_ini, o2 = w_ini;
    NOT_Base (X1, X1_not);
    NOT_Base (X2, X2_not);
    NOT_Base (Y, Y_not);
    AND_Base (X1_not, Y_not, o1);
    AND_Base (X2_not, Y_not, o2);
    OR_Base (o1, o2, OUT);
...
void comp_gates::AOI22 (wire& X1, wire& X2, wire& Y1, wire& Y2, wire& OUT) {
    wire w_ini;
    w_ini.value = 0;
    wire X1_not = w_ini, X2_not = w_ini, Y1_not = w_ini, Y2_not = w_ini;
    wire o1 = w_ini, o2 = w_ini, o3 = w_ini, o4 = w_ini, o5 = w_ini, o6 = w_ini;
    NOT_Base (X1, X1_not);
    NOT_Base (X2, X2_not);
    NOT_Base (Y1, Y1_not);
    NOT_Base (Y2, Y2_not);
    AND_Base (X1_not, Y1_not, o1);
    AND_Base (X1_not, Y2_not, o2);
    AND_Base (X2_not, Y1_not, o3);
    AND_Base (X2_not, Y2_not, o4);
    OR_Base (o1, o2, o5);
    OR_Base (o3, o4, o6);
    OR_Base (o5, o6, OUT);
...
void comp_gates::AOI221 (wire& X1, wire& X2, wire& Y1, wire& Y2, wire& K, wire& OUT) {
	wire w_ini;
	w_ini.value = 0;
	wire X1_not = w_ini, X2_not = w_ini, Y1_not = w_ini, Y2_not = w_ini, K_not;
	wire o1 = w_ini, o2 = w_ini, o3 = w_ini, o4 = w_ini, o5 = w_ini, o6 = w_ini, o7 = w_ini, o8 = w_ini, o9 = w_ini, o10 = w_ini;
	NOT_Base (X1, X1_not);
	NOT_Base (X2, X2_not);
	NOT_Base (Y1, Y1_not);
	NOT_Base (Y2, Y2_not);
	NOT_Base (K, K_not);
	AND_Base (X1_not, Y1_not, o1);
	AND_Base (o1, K_not, o2);
	AND_Base (X1_not, Y2_not, o3);
	AND_Base (o3, K_not, o4);
	AND_Base (X2_not, Y1_not, o5);
	AND_Base (o5, K_not, o6);
	AND_Base (X2_not, Y2_not, o7);
	AND_Base (o7, K_not, o8);
	OR_Base (o2, o4, o9);
	OR_Base (o6, o8, o10);
	OR_Base (o9, o10, OUT);
...
void comp_gates::AOI222 (wire& X1, wire& X2, wire& Y1, wire& Y2, wire& K1, wire& K2, wire& OUT) {
	wire w_ini;
	w_ini.value = 0;
	wire X1_not = w_ini, X2_not = w_ini, Y1_not = w_ini, Y2_not = w_ini, K1_not = w_ini, K2_not = w_ini;
	...
	NOT_Base (K2, K2_not);
	AND_Base (X1_not, Y1_not, o1);
	AND_Base (o1, K1_not, o2);
	AND_Base (X1_not, Y1_not, o3);
	AND_Base (o3, K2_not, o4);
	AND_Base (X1_not, Y2_not, o5);
	AND_Base (o5, K1_not, o6);
	AND_Base (X1_not, Y2_not, o7);
	AND_Base (o7, K2_not, o8);
	AND_Base (X2_not, Y1_not, o9);
	AND_Base (o9, K1_not, o10);
	AND_Base (X2_not, Y1_not, o11);
	AND_Base (o11, K2_not, o12);
	AND_Base (X2_not, Y2_not, o13);
	AND_Base (o13, K1_not, o14);
	AND_Base (X2_not, Y2_not, o15);
	AND_Base (o15, K2_not, o16);
	OR_Base (o2, o4, o17);
	OR_Base (o6, o8, o18);
	OR_Base (o10, o12, o19);
	OR_Base (o14, o16, o20);
...
void comp_gates::OAI21 (wire& X1, wire& X2, wire& Y, wire& OUT) {
	wire w_ini;
	w_ini.value = 0;
	wire X1_not = w_ini, X2_not = w_ini, Y_not = w_ini, o1 = w_ini, o2 = w_ini, TEMP_YEK = w_ini;
	TEMP_YEK.w_func.clear();
	TEMP_YEK.w_func.push_back("YEK");
	TEMP_YEK.w_func.push_back("-");
	TEMP_YEK.w_func.push_back("*");
	...
	NOT_Base (X2, X2_not);
	NOT_Base (Y, Y_not);
	AND_Base (X1_not, X2_not, o1);
	AND_Base (Y_not, TEMP_YEK, o2);
	OR_Base (o1, o2, OUT);
...
bool encoder::parse_calc (deque<string> function, deque<func_in> func_inputs) {
    ...
    deque<split>::size_type split_indx = 0;			// The Index of Splitter Container.
    ...
    deque<oprt_type> operate;						// Container for all operators (AND or OR) of the function.

    deque<oprt_type> major_oprt;					// Container for "+" operators (OR Gates).
    ...
    string temp_oprt_signs;							// The signs for all of the operators.

    temp_oprt_signs.clear();

    deque < deque<bool> > clust_results;			// Results of Clusters: Container for the results of each "Cluster".
    ...
    deque < deque<oprt_type> > clust_oprt;			// Container for the operators ("*"s) in each cluster.
    ...
    bool mix_cond = 0;								// Condition for having both "*" and "+" in the boolean function.

    deque<bool> clust_finals;						// Container for Final Result of each Cluster.
...
int main () {
    ...
    for (vector<gate>::size_type gi1 = 0; gi1 < circuit_gates.size(); gi1++) {
        ...
        // *** Considering the Same State "(1-Output)" for both of "SDFFX1" components (1-Output and 2-Output) in here. ***
    	...
    	for (vector<wire>::size_type gi2 = 0; gi2 < circuit_gates[gi1].outputs.size(); gi2++) {
    		if (circuit_gates[gi1].g_name != "INVX0" && circuit_gates[gi1].g_name != "NBUFFX2" && circuit_gates[gi1].g_name != "SDFFX1") {
    	...
    	// Separating the Outputs of the following component.
    	if (circuit_gates[gi1].g_name == "SDFFX1") {
    		circuit_gates[gi1].outputs[0].cont_val = encoder::control_function (circuit_gates[gi1].outputs[0].w_func);
    		circuit_gates[gi1].outputs[1].cont_val = circuit_gates[gi1].outputs[0].cont_val;
    		circuit_gates[gi1].outputs[0].w_func.clear();
    	}
    }
